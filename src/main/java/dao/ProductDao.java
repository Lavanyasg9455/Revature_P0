...
public class ProductDao {
    ...
    public boolean addProduct(ProductDetails product) {
        ...
        String insertProductSQL = "INSERT INTO Product_Details (product_name, product_price, product_image, product_description, seller_id, quantity, discount_price,threshold, category_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public List<ProductDto> getProductDetails(int seller_id) throws ProductsAreUnavailable {
